//
//  SleepCycleManagerDelegate.swift
//  Gamma Stimulator
//
...
class SleepCycleManager: SleepAnalyzerDelegate {
    ...
    // Configuration
    private let stimulationDuration: TimeInterval = 1 * 60 // 15 minutes
    private let minTimeBetweenStimulations: TimeInterval = 1 * 60 // 45 minutes
