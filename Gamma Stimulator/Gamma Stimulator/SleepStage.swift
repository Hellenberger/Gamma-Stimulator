...
class SleepAnalyzer {
    ...
    private let deepSleepDetectionWindow: TimeInterval = 1.0  // 5 minutes of low movement for deep sleep detection
    private let deepSleepConfirmationPeriod: TimeInterval = 1.0  // 1 minute to confirm deep sleep
